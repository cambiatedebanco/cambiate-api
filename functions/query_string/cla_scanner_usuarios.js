...
const get_usuarios_by_rut = () => {
    ...
    email, es_ejecutivo, activo, cargo, fecha_creacion, fecha_actualizacion, 
    sucursal, nivel_acceso, puesto_real, id_cargo, c.nombre as nombre_cargo, idbanco 
...
const get_usuarios_by_email = () => {
    let query = `select rut, dv, nombres, apellido_paterno, apellido_materno, 
    email, es_ejecutivo, activo, cargo, fecha_creacion, fecha_actualizacion, 
    sucursal, nivel_acceso, puesto_real,id_cargo, idbanco
    from "bd_analitica".cla_ceo_usuarios
...
const insert_usuario = () => {
    let query = `insert into "bd_analitica".cla_ceo_usuarios(
        ...
        dv, fecha_actualizacion, usuario_actualiza, id_cargo, idbanco) values(
